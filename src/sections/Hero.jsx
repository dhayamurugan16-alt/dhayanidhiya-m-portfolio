    ...
    return (
        <section id="home" style={{ paddingTop: 108, paddingBottom: 80 }}>
            <div className="wrap">
                ...
                {/* ══ MAIN BENTO GRID ══════════════════════════════════
                    Layout: [Photo col] [Name/Intro col]
                    2 columns: 260px | 1fr
                ═══════════════════════════════════════════════════════ */}
                <motion.div {...fi(0)} className="hero-grid" style={{
                    ...
                    <div className="hero-mid-col" style={{ display: 'flex', flexDirection: 'column', gap: 10 }}>
                        ...
                        {/* Stack & Socials Row */}
                        <div style={{ display: 'grid', gridTemplateColumns: '1fr min-content', gap: 10 }}>
                            {/* Stack card */}
                            ...
                            {/* Socials card */}
                            <Spot className="social-card" style={{ padding: '20px 16px', display: 'flex', alignItems: 'center' }}>
